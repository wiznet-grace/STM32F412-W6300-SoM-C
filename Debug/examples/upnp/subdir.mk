...
C_SRCS += \
../examples/upnp/MakeXML.c \
../examples/upnp/UPnP.c \
../examples/upnp/app_main.c \
../examples/upnp/hyperterminal.c 

OBJS += \
./examples/upnp/MakeXML.o \
./examples/upnp/UPnP.o \
./examples/upnp/app_main.o \
./examples/upnp/hyperterminal.o 

C_DEPS += \
./examples/upnp/MakeXML.d \
./examples/upnp/UPnP.d \
./examples/upnp/app_main.d \
./examples/upnp/hyperterminal.d 


# Each subdirectory must supply rules for building sources it contributes
examples/upnp/%.o examples/upnp/%.su examples/upnp/%.cyclo: ../examples/upnp/%.c examples/upnp/subdir.mk
...
clean: clean-examples-2f-upnp

clean-examples-2f-upnp:
	-$(RM) ./examples/upnp/MakeXML.cyclo ./examples/upnp/MakeXML.d ./examples/upnp/MakeXML.o ./examples/upnp/MakeXML.su ./examples/upnp/UPnP.cyclo ./examples/upnp/UPnP.d ./examples/upnp/UPnP.o ./examples/upnp/UPnP.su ./examples/upnp/app_main.cyclo ./examples/upnp/app_main.d ./examples/upnp/app_main.o ./examples/upnp/app_main.su ./examples/upnp/hyperterminal.cyclo ./examples/upnp/hyperterminal.d ./examples/upnp/hyperterminal.o ./examples/upnp/hyperterminal.su

.PHONY: clean-examples-2f-upnp
