...
C_SRCS += \
../examples/http_server/app_main.c 

OBJS += \
./examples/http_server/app_main.o 

C_DEPS += \
./examples/http_server/app_main.d 


# Each subdirectory must supply rules for building sources it contributes
examples/http_server/%.o examples/http_server/%.su examples/http_server/%.cyclo: ../examples/http_server/%.c examples/http_server/subdir.mk
...
clean: clean-examples-2f-http_server

clean-examples-2f-http_server:
	-$(RM) ./examples/http_server/app_main.cyclo ./examples/http_server/app_main.d ./examples/http_server/app_main.o ./examples/http_server/app_main.su

.PHONY: clean-examples-2f-http_server
