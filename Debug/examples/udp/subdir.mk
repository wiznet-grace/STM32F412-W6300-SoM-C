...
C_SRCS += \
../examples/udp/app_main.c 

OBJS += \
./examples/udp/app_main.o 

C_DEPS += \
./examples/udp/app_main.d 


# Each subdirectory must supply rules for building sources it contributes
examples/udp/%.o examples/udp/%.su examples/udp/%.cyclo: ../examples/udp/%.c examples/udp/subdir.mk
...
clean-examples-2f-udp:
	-$(RM) ./examples/udp/app_main.cyclo ./examples/udp/app_main.d ./examples/udp/app_main.o ./examples/udp/app_main.su
