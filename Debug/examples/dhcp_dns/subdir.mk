...
C_SRCS += \
../examples/dhcp_dns/app_main.c 

OBJS += \
./examples/dhcp_dns/app_main.o 

C_DEPS += \
./examples/dhcp_dns/app_main.d 


# Each subdirectory must supply rules for building sources it contributes
examples/dhcp_dns/%.o examples/dhcp_dns/%.su examples/dhcp_dns/%.cyclo: ../examples/dhcp_dns/%.c examples/dhcp_dns/subdir.mk
...
clean: clean-examples-2f-dhcp_dns

clean-examples-2f-dhcp_dns:
	-$(RM) ./examples/dhcp_dns/app_main.cyclo ./examples/dhcp_dns/app_main.d ./examples/dhcp_dns/app_main.o ./examples/dhcp_dns/app_main.su

.PHONY: clean-examples-2f-dhcp_dns
