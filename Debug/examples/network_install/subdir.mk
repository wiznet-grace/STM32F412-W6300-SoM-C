...
C_SRCS += \
../examples/network_install/app_main.c 

OBJS += \
./examples/network_install/app_main.o 

C_DEPS += \
./examples/network_install/app_main.d 


# Each subdirectory must supply rules for building sources it contributes
examples/network_install/%.o examples/network_install/%.su examples/network_install/%.cyclo: ../examples/network_install/%.c examples/network_install/subdir.mk
...
clean: clean-examples-2f-network_install

clean-examples-2f-network_install:
	-$(RM) ./examples/network_install/app_main.cyclo ./examples/network_install/app_main.d ./examples/network_install/app_main.o ./examples/network_install/app_main.su

.PHONY: clean-examples-2f-network_install
