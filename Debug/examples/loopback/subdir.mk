...
C_SRCS += \
../examples/loopback/app_main.c 

OBJS += \
./examples/loopback/app_main.o 

C_DEPS += \
./examples/loopback/app_main.d 


# Each subdirectory must supply rules for building sources it contributes
examples/loopback/%.o examples/loopback/%.su examples/loopback/%.cyclo: ../examples/loopback/%.c examples/loopback/subdir.mk
...
clean-examples-2f-loopback:
	-$(RM) ./examples/loopback/app_main.cyclo ./examples/loopback/app_main.d ./examples/loopback/app_main.o ./examples/loopback/app_main.su
