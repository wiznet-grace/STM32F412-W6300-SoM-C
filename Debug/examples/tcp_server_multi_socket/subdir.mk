...
C_SRCS += \
../examples/tcp_server_multi_socket/app_main.c 

OBJS += \
./examples/tcp_server_multi_socket/app_main.o 

C_DEPS += \
./examples/tcp_server_multi_socket/app_main.d 


# Each subdirectory must supply rules for building sources it contributes
examples/tcp_server_multi_socket/%.o examples/tcp_server_multi_socket/%.su examples/tcp_server_multi_socket/%.cyclo: ../examples/tcp_server_multi_socket/%.c examples/tcp_server_multi_socket/subdir.mk
...
clean: clean-examples-2f-tcp_server_multi_socket

clean-examples-2f-tcp_server_multi_socket:
	-$(RM) ./examples/tcp_server_multi_socket/app_main.cyclo ./examples/tcp_server_multi_socket/app_main.d ./examples/tcp_server_multi_socket/app_main.o ./examples/tcp_server_multi_socket/app_main.su

.PHONY: clean-examples-2f-tcp_server_multi_socket
