...
C_SRCS += \
../examples/sntp/app_main.c 

OBJS += \
./examples/sntp/app_main.o 

C_DEPS += \
./examples/sntp/app_main.d 


# Each subdirectory must supply rules for building sources it contributes
examples/sntp/%.o examples/sntp/%.su examples/sntp/%.cyclo: ../examples/sntp/%.c examples/sntp/subdir.mk
...
clean-examples-2f-sntp:
	-$(RM) ./examples/sntp/app_main.cyclo ./examples/sntp/app_main.d ./examples/sntp/app_main.o ./examples/sntp/app_main.su
