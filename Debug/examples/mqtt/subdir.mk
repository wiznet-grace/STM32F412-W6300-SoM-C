...
C_SRCS += \
../examples/mqtt/app_main.c 

OBJS += \
./examples/mqtt/app_main.o 

C_DEPS += \
./examples/mqtt/app_main.d 


# Each subdirectory must supply rules for building sources it contributes
examples/mqtt/%.o examples/mqtt/%.su examples/mqtt/%.cyclo: ../examples/mqtt/%.c examples/mqtt/subdir.mk
...
clean: clean-examples-2f-mqtt

clean-examples-2f-mqtt:
	-$(RM) ./examples/mqtt/app_main.cyclo ./examples/mqtt/app_main.d ./examples/mqtt/app_main.o ./examples/mqtt/app_main.su

.PHONY: clean-examples-2f-mqtt
